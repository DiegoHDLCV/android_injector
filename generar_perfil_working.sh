...
# llaves_prueba_20251022_114542.json para operaciones diarias del sistema
# =============================================================================
...
echo -e "${BLUE}⚙️ Generador de Perfil de Prueba con Llaves Working${NC}"
echo -e "${BLUE}================================================${NC}"
...
OUTPUT_FILE="perfil_working_${TIMESTAMP}.json"
...
echo -e "${YELLOW}📝 Generando perfil de llaves working...${NC}"

# Iniciar el JSON del perfil
cat > "$OUTPUT_FILE" << EOF
{
  "name": "Perfil Working Keys Operacionales",
  "description": "Perfil de prueba con llaves working para operaciones diarias del sistema (PIN, MAC, DATA)",
...
# Contador para slots (empezar desde slot 01 para working keys)
SLOT_COUNTER=1
...
# Mostrar resumen
echo -e "${GREEN}✅ Perfil de llaves working generado exitosamente!${NC}"
echo -e "${GREEN}📁 Archivo: $OUTPUT_FILE${NC}"
echo ""
echo -e "${BLUE}📊 Resumen del perfil generado:${NC}"
echo -e "   📝 Nombre: Perfil Working Keys Operacionales"
echo -e "   🏷️  Tipo: Retail"
echo -e "   🔑 Configuraciones: $((PIN_COUNTER + MAC_COUNTER + DATA_COUNTER)) llaves working"
...
echo -e "   3. Este perfil contiene llaves working para operaciones diarias"
echo -e "   4. Usa este perfil DESPUÉS de haber configurado las llaves maestras"
echo ""
echo -e "${GREEN}🎉 ¡Perfil de llaves working listo para usar!${NC}"
